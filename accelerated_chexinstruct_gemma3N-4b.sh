...
accelerate launch   --config_file deepspeed/ds_zero3_config_4process.yaml   --main_process_port 29700 src/finetune/finetune_accelerated.py \
                    ...
                    --output_dir ./reports/finetune_gemma-3n-4b_findings \
                    --learning_rate 2e-4 \
